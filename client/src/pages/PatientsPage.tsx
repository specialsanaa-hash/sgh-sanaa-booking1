    ...
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        <div className="container mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">المرضى والزوار</h1>
          ...
          <p className="text-base md:text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
            نعمل على تطوير هذا القسم لتقديم أفضل الخدمات والمعلومات للمرضى والزوار. يرجى العودة قريباً.
          </p>
          <Link href="/website">
